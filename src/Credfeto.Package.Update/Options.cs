...
public sealed class Options
{
    [Option(
        ...
        longName: "package-id",
        Required = true,
        HelpText = "Package Id to check for updates"
    )]
    ...
    [Option(
        ...
        longName: "folder",
        Required = true,
        HelpText = "Folder containing projects"
    )]
    ...
    [Option(
        ...
        longName: "source",
        Required = false,
        HelpText = "Urls to additional NuGet feeds to load"
    )]
    ...
    [Option(
        ...
        longName: "exclude",
        Required = false,
        HelpText = "Package Ids to exclude from the update"
    )]
